...
plt_all <- (tree_show | dot_size_plot | alg6_plot | sex_chr_plot) +
            plot_layout(widths = c(6, 1, 1, 1))
ggsave("figures/fig3_core.png", plot=plt_all, dpi=600, width = 6, height = 10)
ggsave("figures/fig3_core.svg", plot=plt_all, dpi=600, width = 6, height = 10)
###
